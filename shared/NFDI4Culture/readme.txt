Authors: Gudrun Knaus (contents), Celia Krause (technical implementation)
Date: 2025-09-08
Version: 1.0
...
Installation:
The XML files are a 'full XML' export and contain all the elements required for import into RDMO. Both files are freely available under the CC BY-NC-SA licence (https://creativecommons.org/licenses/by-nc-sa/4.0/). For questions and comments, please email rdmo@ulb.tu-darmstadt.de.

Acknowledgements:
This publication was made possible by Base4NFDI. Base4NFDI is funded by the Deutsche Forschungsgemeinschaft (DFG, German Research Foundation), as part of the National Research Data Infrastructure (NFDI), under project number 521453681.

Several parties contributed to the development of the catalogues. The authors would like to express their sincere thanks to all those involved in the process, especially Katjana Berndt, Angela Kailus and Daniel Röwenstrunk for valuable feedback, and Sabine Schönau for technical assistance.
